...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.findDNS.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".findDNS" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".findDNS")
	}
